module.exports = (robot) ->
	robot.hear /fuck|damn|shit|dammit/i, (msg) ->
		...
		threats = ["I'm still keeping track of your language.",
					...
					"I think #{curseCount} is a good number to stop at. Just quit while you're ahead.",
		...
		if curseCount == 1
			msg.reply "Inappropriate language will not be tolerated. This is your only warning."
		else if curseCount == 2
			msg.send "I warned you once about language, #{msg.message.user.name}, and you didn't heed me. That was your mistake."
			...
			msg.send "Good news <!everyone>, because #{msg.message.user.name} can't stop swearing, they now have to buy the whole club pizza. Think of it like a delicious swear jar. See you all at the pizza party!"
